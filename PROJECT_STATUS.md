...
> 历史记录：下文是早期 Java 与课程查询方案的初始化报告，不代表当前查课系统已实现或验收。2026-09-20 已将技术基线调整为 FastAPI + SQLAlchemy + Alembic + MySQL + openpyxl，详见[技术方案 V1.4](查课管理系统V1.0开发技术方案.md)。旧数据库模型和初始化指南待同步。
