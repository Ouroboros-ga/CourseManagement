...
> 历史指南，待同步：本文件保留早期 Java 与课程查询方案，以下命令、API、开发计划不适用于当前选型。当前采用 FastAPI + SQLAlchemy + Alembic + MySQL + openpyxl，请以[技术方案 V1.4](查课管理系统V1.0开发技术方案.md)为准。当前后端已有初始工程与迁移，仍需按新基线完善，不要按本文件直接初始化当前系统。
